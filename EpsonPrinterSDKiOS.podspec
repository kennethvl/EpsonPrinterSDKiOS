Pod::Spec.new do |s|
  s.name         = 'EpsonPrinterSDKiOS'
  s.version      = '2.17.0'
  s.summary      = 'Epson ePOS_SDK_iOS_v2.17.0 for iOS'
  s.description  = <<-DESC
  ...
  s.platform     = :ios, '11.0'
  s.source       = { :git => 'https://github.com/kennethvl/EpsonPrinterSDKiOS.git', :tag => s.version.to_s }
  s.source_files  = '*.h'
